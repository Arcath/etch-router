...
class Output{
  ...
  render(){
    ...
    if(this.props.route.props.component.hasOwnProperty('propsForComponent')){
      this.props.route.props.component.propsForComponent(this.props.router.currentPath, componentProps)
    }
